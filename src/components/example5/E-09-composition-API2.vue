...
import { ref, computed, watch, onBeforeMount, onMounted,
  onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted, defineProps, defineOptions } from 'vue';

defineOptions({ name: 'E09CompositionApi' })
